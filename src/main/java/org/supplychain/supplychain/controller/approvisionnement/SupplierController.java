...
public class SupplierController {
    ...
    public ResponseEntity<SuccessResponse<SupplierResponse>> createSupplier(
        ...
        SuccessResponse<SupplierResponse> response = SuccessResponse.of(
                HttpStatus.CREATED,
    ...
    @GetMapping
    @PreAuthorize("hasRole('GESTIONNAIRE_APPROVISIONNEMENT') or hasRole('SUPERVISEUR_LOGISTIQUE') or hasRole('RESPONSABLE_ACHATS')")
    public ResponseEntity<SuccessResponse<Page<SupplierResponse>>> getAllSuppliers(
        ...
        SuccessResponse<Page<SupplierResponse>> response = SuccessResponse.of(
                HttpStatus.OK,
    ...
    @GetMapping("/search")
    @PreAuthorize("hasRole('GESTIONNAIRE_APPROVISIONNEMENT') or hasRole('RESPONSABLE_ACHATS')")
    public ResponseEntity<SuccessResponse<Page<SupplierResponse>>> searchSuppliersByName(
