...
public class ProductController {
        ...
        @DeleteMapping("/{id}")
        @PreAuthorize("hasRole('CHEF_PRODUCTION')")
        @Operation(summary = "Supprimer un produit", description = "Supprime un produit s'il n'existe aucun ordre de production associé")
        ...
        @GetMapping
        @Operation(summary = "Consulter la liste complète des produits", description = "Récupère tous les produits avec pagination")
        ...
        @Operation(summary = "Rechercher un produit par nom", description = "Recherche des produits par nom avec pagination")
